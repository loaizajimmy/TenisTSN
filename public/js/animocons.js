...
;(function (window) {
    ...
    function putEfects() {
        $('button.icobutton').each(function (index, item) {
            let el1 = $(item)[0];
            console.log(el1);
            let el1span = el1.querySelector('i');
            init(el1, el1span);
        });
    }

    $('button.icobutton').on('click', function () {
